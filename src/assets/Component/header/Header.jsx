      ...
      >
        <div id="gh-main" className="flex items-center relative container">
          ...
          <div className="gh-desktop gh-menu-and-language">
            <ul className="nav flex items-center space-x-8"> {/* Thêm khoảng cách giữa các mục */}
              <li className="nav-item relative"> {/* Đặt vị trí tương đối cho mục cha */}
                <a href="#global-course" className="flex items-center">
                  Khoá học
                  <CaretDownOutlined className="ml-2" />
                </a>

                <ul className="subnav absolute bg-white mt-2 p-4 shadow-lg"> {/* Định dạng menu con */}
